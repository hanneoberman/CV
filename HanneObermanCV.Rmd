...
tribble(
  ~Year, ~Job, ~Desc, ~Where,
  "since 2020", "Junior researcher", "Data visualization for uncertainty/missing data. With Dr. Gerko Vink and Prof. Dr. Stef van Buuren. My task is to develop an interactive evaluation device for multiple imputation of missing data. I am proficient with the `R` package `{shiny}` and the `{golem}` framework for production-grade applications.", "Utrecht University",
